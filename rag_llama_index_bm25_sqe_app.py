...
tokenizer_model = 'cognitivecomputations/dolphin-2.6-mistral-7b-dpo-laser'
...
tokenizer = AutoTokenizer.from_pretrained(tokenizer_model, legacy=False)
...
vector_retriever = vector_index.as_retriever(similarity_top_k=9)
keyword_retriever = keyword_index.as_retriever(similarity_top_k=9)
bm25_retriever = BM25Retriever.from_defaults(nodes=nodes, similarity_top_k=9)
...
reranker = SentenceTransformerRerank(top_n=13, model=rerank_model)
