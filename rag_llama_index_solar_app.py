...
# For the time being, we are using SOLAR 10.7GB Instruct.
...
# With the current model, if the context is not too long, probably 12GB of VRAM will suffice. You can switch to Q4 if you want to save VRAM.
...
name = 'kyujinpy/Sakura-SOLAR-Instruct'
model_name = 'TheBloke/Sakura-SOLAR-Instruct-GGUF'
model_file = 'sakura-solar-instruct.Q5_K_M.gguf'
