...
# The current leader in Huggingface is SOLAR but it hallucinates way too much, even in a RAG scenario. 
# This could certaining improve by tuning the temperature and other parameters.
# For the time being, we are back to Tulu. Medium-sized quantised model. You can switch to the Q4 if you want to save VRAM.
...
# With the current model, if the context is not too long, probably 8GB of VRAM will suffice.
